      ...
      <b-tabs content-class="mt-3">
        <b-tab title="Mijn Account" active>
          ...
          <div v-if="currentBranch != null">
            ...
            ></imageEditor>
            <events v-bind:user="user" v-bind:branchName="currentBranch.branchName"></events>
          </div>
        </b-tab>
        ...
        <b-tab title="Accounts beheren" v-if="user.admin == 1">
          <accountManager v-bind:user="user" v-bind:branches="branches"></accountManager>
        </b-tab>
      </b-tabs>
    </b-container>
  </section>
